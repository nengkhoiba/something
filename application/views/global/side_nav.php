<aside id="s-user-alerts" class="sidebar">
                <ul class="tab-nav tn-justified tn-icon m-t-10" data-tab-color="teal">
                    ...
                    <li><a class="sua-settings" href="#sua-settings" data-toggle="tab"><i class="zmdi zmdi-settings"></i></a></li>
                </ul>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade" id="sua-messages">
                        ...
                        <div class="list-group lg-alt c-overflow">
                            <a href="#" class="list-group-item media">
                                <div class="pull-left">
                                    <img class="avatar-img" src="<?php echo base_url();?>assets/img/profile-pics/1.jpg" alt="">
                                </div>
                            ...
                            <a href="#" class="list-group-item media">
                                <div class="pull-left">
                                    <img class="avatar-img" src="<?php echo base_url();?>assets/img/profile-pics/5.jpg" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <a href="#" class="list-group-item media">
                                <div class="pull-left">
                                    <img class="avatar-img" src="<?php echo base_url();?>assets/img/profile-pics/3.jpg" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <a href="#" class="list-group-item media">
                                <div class="pull-left">
                                    <img class="avatar-img" src="<?php echo base_url();?>assets/img/profile-pics/4.jpg" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <a href="#" class="list-group-item media">
                                <div class="pull-left">
                                    <img class="avatar-img" src="<?php echo base_url();?>assets/img/profile-pics/2.jpg" alt="">
                                </div>
                                <div class="media-body">
                    ...
                    <div class="tab-pane fade" id="sua-settings">
            ...
            <aside id="s-main-menu" class="sidebar">
                ...
                <ul class="smm-alerts">
                    ...
                    <li data-user-alert="sua-settings" data-ma-action="sidebar-open" data-ma-target="user-alerts">
                ...
                <ul class="main-menu">
                    <li>
                        <a href="<?php echo base_url()?>home" ><i class="zmdi zmdi-chart"></i> Dashboards</a>
                    </li>
                    <li>
                    	<a href="<?php echo base_url()?>location"><i class="zmdi zmdi-map"></i>Track Location</a>
                    </li>
                    <li>
                    	<a href="#"><i class="zmdi zmdi-directions"></i>Travel</a>
                    </li>
                    <li>
                    	<a href="<?php echo base_url()?>chat"><i class="zmdi zmdi-comment"></i>Chat</a>
                    </li>
