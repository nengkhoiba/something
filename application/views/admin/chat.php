                        ...
                        <div class="ms-menu">
                            ...
                            <div class="list-group lg-alt m-t-10">
                                <a class="list-group-item media" href="#">
                                    <div class="pull-left">
                                        <img src="<?php echo base_url();?>assets/img/profile-pics/4.jpg" alt="" class="avatar-img">
                                    </div>
                                ...
                                <a class="list-group-item media" href="#">
                                    <div class="pull-left">
                                        <img src="<?php echo base_url();?>assets/img/profile-pics/2.jpg" alt="" class="avatar-img">
                                    </div>
                                    <div class="media-body">
                                ...
                                <a class="list-group-item media" href="#">
                                    <div class="pull-left">
                                        <img src="<?php echo base_url();?>assets/img/profile-pics/3.jpg" alt="" class="avatar-img">
                                    </div>
                                    <div class="media-body">
                                ...
                                <a class="list-group-item media" href="#">
                                    <div class="pull-left">
                                        <img src="<?php echo base_url();?>assets/img/profile-pics/5.jpg" alt="" class="avatar-img">
                                    </div>
                                    <div class="media-body">
                                ...
                                <a class="list-group-item media" href="#">
                                    <div class="pull-left">
                                        <img src="<?php echo base_url();?>assets/img/profile-pics/1.jpg" alt="" class="avatar-img">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="list-group lg-alt">
                                ...
                                <div class="list-group-item media">
                                    <div class="pull-right">
                                        <img class="avatar-img" src="<?php echo base_url();?>assets/img/profile-pics/8.jpg" alt="">
                                    </div>
                                    <div class="media-body">
                                        <div>
                                            <div class="msb-item">
